...
public class FTPLocalFileSystemPane extends VBox {
  ...
  public FTPLocalFileSystemPane() {
    ...
    bg = new HBox();
    b1 = new Button("Upload File(s)", fontAwesome.create(FontAwesome.Glyph.UPLOAD).color(Color.BLUE));
  ...
  public void setStatusLabel(int dirSize, int fileNum, long bytes) {
    ...
    this.status.setText(dirSize + " Directory. " + fileNum + " Files." + " Total size: "
        + formatter.format(bytes) + " bytes");
  }
